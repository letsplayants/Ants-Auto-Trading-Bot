    ...
    def _get(self, url, headers=None, data=None, params=None):
        ...
        try:
            if resp.status_code in [200, 201]:
                ...
                logging.warning('get(%s) cmd failed(%d) text(%s)' % (url, resp.status_code, resp.text) )
                return None
            else:
    ...
    def _post(self, url, headers, data):
        ...
        try:
            if resp.status_code in [200, 201]:
                ...
                print( colored( 'post(%s) cmd failed(%d) text(%s)' % (url, resp.status_code, resp.text), 'yellow' ) )
                return None
            else:
    ...
    def _delete(self, url, headers, data):
        ...
        try:
            if resp.status_code in [200, 201]:
                ...
                logging.warning('delete(%s) cmd failed(%d) text(%s)' % (url, resp.status_code, resp.text) )
                return None
            else:
